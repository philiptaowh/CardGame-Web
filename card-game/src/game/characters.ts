...
export const CHARACTERS: Record<CharacterId, CharacterCard> = {
  ...
  char_5: {
    ...
    skills: [
      ...
      { name: '突袭', cost: 3, description: '指定一位其他玩家，使其受到3点伤害和3点穿透，然后若该玩家还未行动，则为自己附加"鼓舞"印记1回合' },
  ...
  char_7: {
    ...
    skills: [
      ...
      { name: '衰弱', cost: 2, description: '指定一位其他玩家，使其附加"弱化"印记2回合，若该玩家已拥有"弱化"印记，则为自己附加"治疗"印记2回合' },
      { name: '虚弱', cost: 3, description: '指定一位其他玩家，附加"弱化"印记2回合，若该玩家已拥有"弱化"印记，则附加"失明"和"失神"印记1回合' },
